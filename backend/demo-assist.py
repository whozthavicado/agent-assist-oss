...
def suggest_reply(signals: List[str]) -> str:
    ...
    if "hesitation" in signals:
        return (
            "That makes sense. What would help you feel more confident about the next step?"
        )

    return (
        "Thanks for sharing that. Let me summarize your situation and guide the next best step clearly."
    )
